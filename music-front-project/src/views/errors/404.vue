    ...
    <div class="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
      ...
      <div class="mx-auto max-w-7xl px-6 lg:px-8 text-center">
        <div class="mx-auto lg:mx-0">
          <h2 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">404</h2>
          <p class="mt-6 text-lg leading-8 text-gray-300">Pagina no encontrada.</p>
          <a href="/" class="text-sm font-semibold"><span aria-hidden="true">&larr;</span>Regresar al inicio</a>
        </div>
      </div>
    </div>
  </template>
